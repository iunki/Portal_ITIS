...
<script src="/resources/js/ajax/courses.js"></script>
  ...
  <div class="col-lg-5  col-lg-push-1 lab">
      <div class="row">
          <div class="col-lg-12">
              <div class="ibox float-e-margins">
                  <div class="ibox-title">
                      <h5>Ваш курс по выбору</h5>
                  </div>

                  <div class="ibox-content">

                      <p> Вы отправили заявку на курс Lamp  <br> Ваша заявка находится на рассмотрениии.  </p>
                  </div>
      ...
      <div class="row">
          <div class="col-lg-12">
              <div class="ibox float-e-margins">
                  <div class="ibox-title">
                      <h5>Описание курса по выбору</h5>
                  </div>
